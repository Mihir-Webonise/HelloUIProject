...
public class SendoffActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnGreet.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				showGreet.setText("Goodbye " + enterName.getText() + " !");
			}
		});
		...
		switchGreet.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				// TODO Auto-generated method stub
				intent = new Intent(SendoffActivity.this, HelloUIProjectActivity.class );
